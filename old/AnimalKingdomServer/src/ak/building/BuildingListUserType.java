...
public class BuildingListUserType extends AbstractBlobUserType {
	
	protected static final Logger log = LoggerFactory.getLogger(BuildingListUserType.class);
	...
	public Object deepCopy(Object value) throws HibernateException {
		if (value == null)
			return null;
		try {
			return ((BuildingList) value).clone();
	...
	public Object makeObject(byte[] bytes, Object owner) throws Exception {
		if (bytes == null) {
			...
			return BuildingList.parse(bytes);
		}
	}
	...
	public byte[] makeBytes(Object object) {
		if (object == null)
			...
			try {
				return ((BuildingList) object).toDbData();
			} catch (IOException e) {
