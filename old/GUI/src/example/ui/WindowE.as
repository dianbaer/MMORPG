package example.ui
{
	...
	public class WindowE extends Sprite
	{
		private var win : Window
		public function WindowE()
		{
			super();
			/** Window **/
		...
		private function onFocusOut(event:FocusEvent):void{
			if(event.currentTarget.name == "gapH" || event.currentTarget.name == "gapW"){
				...
				win[event.currentTarget.name] = (getChildByName(event.currentTarget.name) as TextInput).text;
			}
