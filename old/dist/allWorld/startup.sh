...
$JAVA_HOME/bin/java -Xms1024m -Xmx2048m -XX:PermSize=256m -XX:MaxPermSize=512m -classpath "./lib/allWorld.jar:$CLASSPATH:.:$LIB_PATH" cyou.akworld.World $@>> allWorld.log 2>&1 &
